    ...
    fun render(input: File, output: File, config: SpatialAudioConfig): SpatialRenderMetrics {
        ...
        val stereoPost = try {
            SpatialStereoPostProcessor.process(
                ...
                preserveSourceSide = value.trajectory == SpatialTrajectory.STATIC,
            )
        } finally {
            nativeOutput.delete()
        }
        ...
        return SpatialRenderMetrics(
            ...
            stereoMode = json.optString("stereo_mode", stereoPost.mode),
            ...
            objectAmbienceBedGain = json.float("object_ambience_bed_gain"),
            objectLateralCueDb = json.float("object_lateral_cue_db", 4.5f),
            directRearLowpassHz = json.float("direct_rear_lowpass_hz", 6_800f),
            reflectionLowpassHz = json.float("reflection_lowpass_hz", 9_000f),
            reflectionGateFloorDbfs = json.float("reflection_gate_floor_dbfs", -62f),
...
data class SpatialRenderMetrics(
    ...
    val objectAmbienceBedGain: Float,
    val objectLateralCueDb: Float,
    val directRearLowpassHz: Float,
    val reflectionLowpassHz: Float,
    ...
    fun diagnosticFields(): Map<String, Any?> = mapOf(
        ...
        "object_ambience_bed_gain" to objectAmbienceBedGain,
        "object_lateral_cue_db" to objectLateralCueDb,
        "direct_rear_lowpass_hz" to directRearLowpassHz,
        "reflection_lowpass_hz" to reflectionLowpassHz,
